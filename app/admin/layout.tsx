        ...
        <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#0a0a0a' }}>
            ...
            <aside className="admin-sidebar" style={{
                ...
                <div style={{ marginBottom: '2rem', paddingBottom: '1.5rem', borderBottom: '1px solid #1e1e1e', textAlign: 'center' }}>
                    <Link href="/admin" style={{ display: 'flex', justifyContent: 'center', textDecoration: 'none' }}>
                        <Image src="/uploads/ryansautowhite.png" alt="Ryan's Auto Solution" width={160} height={54} style={{ objectFit: 'contain' }} priority />
                    </Link>
                    <div style={{ fontSize: '0.65rem', color: '#888', textTransform: 'uppercase', letterSpacing: '2px', marginTop: '0.75rem' }}>Admin Console</div>
                </div>
